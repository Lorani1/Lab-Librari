...
const apiUrl = 'https://localhost:7101/api'; // Adjust URL as per your API endpoint
...
const getNotifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      console.log('Notification API Response:', response.data); // Log response for debugging
